 ...
 * </p>
 */
public class LottieSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
    ...
    private AnimationListener mRefreshListener = new AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                mProgress.setImageAlpha(MAX_ALPHA);
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link LottieSwipeRefreshLayout#onSaveInstanceState()}
         */
...
//        mCircleView.getBackground().setAlpha(targetAlpha);
        mProgress.setImageAlpha(targetAlpha);
    }
     ...
     * @param context
     */
    public LottieSwipeRefreshLayout(@NonNull Context context) {
        this(context, null);
    }
    ...
    public LottieSwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        setSize(a.getResourceId(2, R.dimen.lottie_size_default));
    ...
    private void startProgressAlphaStartAnimation() {
        mAlphaStartAnimation = startAlphaAnimation(mProgress.getImageAlpha(), STARTING_PROGRESS_ALPHA);
    }

    private void startProgressAlphaMaxAnimation() {
        mAlphaMaxAnimation = startAlphaAnimation(mProgress.getImageAlpha(), MAX_ALPHA);
    }
...
//        mProgress.setColorSchemeColors(colors);
    ...
    /**
     * Set a callback to override {@link LottieSwipeRefreshLayout#canChildScrollUp()} method. Non-null
...
//            mProgress.setArrowEnabled(false);
    ...
    private void startDragging(float y) {
        ...
        if (yDiff > mTouchSlop && !mIsBeingDragged) {
            ...
            mProgress.setImageAlpha(STARTING_PROGRESS_ALPHA);
        }
    }
    ...
    private void animateOffsetToStartPosition(int from, Animator.AnimatorListener listener) {
        if (mScale) {
            ...
            if (listener != null) {
                mCircleView.addAnimatorListener(listener);
            }
            mCircleView.clearAnimation();
...
//            mProgress.setArrowScale(1 - interpolatedTime);
    ...
    /**
     * Classes that wish to override {@link LottieSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link LottieSwipeRefreshLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull LottieSwipeRefreshLayout parent, @Nullable View child);
    }
}
